...
[plantuml, esl4a/generated/overview, png, caption="{classdia-caption} {counter:class}: ", 650]
----
include::{plantumldir}/ESL4A/overview.plantuml[]
----
...
The implementation in Android (requires API level 29) should be asynchronous as in the following example:
